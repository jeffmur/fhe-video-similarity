...
import 'package:flutter_fhe_video_similarity/page/grid.dart';

void main() {
  runApp(MaterialApp(home: SelectableGrid(
    items: [],
  )));
}
    ...
    return MaterialApp(
      home: Scaffold(
        ...
        floatingActionButton: m
            .floatingSelectMediaFromGallery(MediaType.video, context,
